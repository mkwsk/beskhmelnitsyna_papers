...
key_file: "items/gavrilova_professional_self_realization_key.csv"
...
Методика сохранена в архиве как резерв по профессиональной самореализации. Она прямо близка к профессиональной части темы, но сейчас не входит в актуальную батарею.

## Подсчет

Ответы кодируются как `да = 2`, `отчасти верно = 1`, `нет = 0`. Шкалы: ценностно-целевой компонент, ресурсный компонент, феноменологический компонент, общий уровень. Точный ключ пунктов нужно сверить с первоисточником перед автоматическим расчетом.
...
- Полный текст и ключ не внесены в публичный репозиторий.
